...
export default function TabelaClientes() {
  ...
  return (
  	<div>
	    <TableContainer component={Paper} className={classes.container}>
	      <Table className={classes.table}>
	        ...
	        <TableBody>
              ...
              <StyledTableRow hover key={chave} onClick={ () => history.push('/cliente/' + valor['id']) }> 
                <StyledTableCell align="center">{valor['name']}</StyledTableCell>
        ...
        <Fab primary className={classes.botaoFab} onClick={() => { history.push('/cliente') }}>
