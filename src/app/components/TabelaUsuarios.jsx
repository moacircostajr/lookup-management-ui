...
export default function TabelaUsuarios() {
  ...
  return (
  	<div>
	    <TableContainer component={Paper} className={classes.container}>
	      <Table className={classes.table}>
	        ...
	        <TableBody>
              ...
              <StyledTableRow hover key={chave} onClick={ () => history.push('/usuario/' + valor['id']) }> 
                <StyledTableCell align="center">{valor['first_name']}</StyledTableCell>
                <StyledTableCell align="center">{valor['email']}</StyledTableCell>
        ...
        <Fab primary className={classes.botaoFab} onClick={() => { history.push('/usuario') }}>
